...
import StreakUpdater from "../utils/StreakUpdater";
...
const Dashboard = () => {
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", overflow: "hidden" }}>
      ...
      {/* Main Content */}
      <main className="relative z-10 px-4 sm:px-6 md:px-10 lg:px-12 max-w-[1400px] mx-auto">
        {/* Welcome Section */}
        ...
        <div className="flex justify-center mb-6">
          <div className="rounded-lg shadow-md text-center px-4 py-4 w-full max-w-[700px]" style={{ backgroundColor: "var(--quote-bg)" }}>
            <MotivationalQuotes />
          </div>
        </div>
        ...
        {/* Calendar & StreakUpdater */}
        <div className="mb-24 w-full px-4 sm:px-6 md:px-10">
        <StreakUpdater onUpdate={() => setRefreshKey((prev) => prev + 1)} />
