...
const kanji_api = process.env.NEXT_PUBLIC_API_URL;
const update_kanji_api = process.env.NEXT_PUBLIC_API_URL;
...
export  async function update_bookmark_fetch(operation_type, uid, type = "vocab") {
  const json_body = {
    operation_type: operation_type,
    t_id: uid
  };

  const apiUrl = type === "kanji" ? update_kanji_api + "/update_kanji_flag" : update_vocab_api;
